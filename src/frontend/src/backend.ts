...
export class Backend implements backendInterface {
    ...
    async addPrediction(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPrediction(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPrediction(arg0: bigint): Promise<Prediction> {
        if (this.processError) {
            try {
